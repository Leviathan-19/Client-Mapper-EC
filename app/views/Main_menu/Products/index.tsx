...
export const ProductsList: React.FC<any> = ({ navigation }) => {
  ...
  const styles = createProductsStyles(colors);
  ...
  const renderItem = ({ item }: { item: Producto }) => (
    <View style={styles.card}>
      ...
      <Text style={styles.cardText}>
        Precio: ${item.precio_unitario?.toFixed(2) || "0.00"}
      </Text>
      <Text style={styles.cardText}>
        Estado: {item.activo === 1 ? "Activo" : "Inactivo"}
      </Text>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterPicker}>
        ...
        >
          ...
          <ThemedPickerItem label="Activos" value="activo" />
          <ThemedPickerItem label="Inactivos" value="inactivo" />
        </ThemedPicker>
      </View>
                ...
                >
                  <ThemedPicker
                    ...
                    onValueChange={(itemValue) =>
                      setActivo(itemValue as number)
                    }
                    style={{ height: 50, width: "100%" }}
                    mode="dropdown"
                  >
                    <ThemedPickerItem label="Activo" value={1} />
                    <ThemedPickerItem label="Inactivo" value={0} />
                  </ThemedPicker>
                </View>
