  ...
  const saveAgendamiento = async (
    ...
    await powerSync.writeTransaction(async (tx) => {
      ...
      if (!finalEstablecimientoId) {
        if (!newEstablecimiento.nombre.trim())
          throw new Error("Debe seleccionar o crear un establecimiento");
        ...
        await tx.execute(
          ...
          [
            finalEstablecimientoId,
            empresaId,
            finalClienteId || null,
            newEstablecimiento.nombre,
            newEstablecimiento.direccion || null,
            newEstablecimiento.latitud,
            newEstablecimiento.longitud,
            "por_visitar",
          ],
        );
      }
      ...
      await tx.execute(
        ...
        [
          ...
          finalEstablecimientoId,
          empresaId,
          visitaDetails.fecha_programada,
          visitaDetails.fecha_realizada,
      ...
      for (const prod of selectedProducts) {
        ...
        await tx.execute(
          ...
          [
            ...
            parseFloat(prod.precio_unitario),
          ],
        );
      }
    });
